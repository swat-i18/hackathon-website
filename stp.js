...
function fetchDashboardData() {
    ...
    fetch(${API_BASE}/api/dashboard)
        ...
        .then(data => {
            ...
            // Map values for dashboard and overview
            ...
            document.querySelectorAll('.overview-card').forEach(card => {
                ...
                if (h3 && valDiv) {
                    ...
                    if (metricsMap[key] !== undefined) {
                        ...
                        valDiv.innerText = metricsMap[key];
        ...
        .then(data => {
            ...
            if (insightsContainer) {
                ...
                data.slice(0, 3).forEach(insight => {
                    ...
                    div.innerHTML = `<div class="insight-icon">⚠️</div><div class="insight-text"><h3>${insight.title}</h3><p>${insight.message}</p></div>`;
            ...
            if (diagnosticContainer) {
                ...
                data.forEach(insight => {
                    ...
                    div.className = 'insight-item ' + (insight.severity || 'low');
            ...
            if (recommendationsContainer) {
                ...
                data.forEach(insight => {
                    ...
                    div.className = 'insight-item action-required';


                    div.innerHTML = `<div class="insight-icon">💡</div><div class="insight-text"><h3>${insight.title}</h3><p>${insight.recommendation}</p></div>`;
        ...
        .then(data => {
            ...
            if (list) {
                ...
                data.forEach(alert => {
                    ...
                    div.className = 'alert-item ' + (alert.severity || 'low');


                    div.innerHTML = `<div class="alert-icon">🔔</div><div class="alert-content"><h3>${alert.title}</h3><p>${alert.message}</p></div><div class="alert-time">Active</div>`;
...
function loadAnalyticsCharts() {
    ...
    // We will use existing CSS charts for simplicity to preserve design, 


    // or fetch data and update the inline heights.


    fetch(${API_BASE}/api/analytics/energy)
        ...
        .then(data => {
            ...
            if (energyBars.length > 0 && data.length > 0) {


                // Map the last 6 records to the 6 bars
                ...
                recent.forEach((record, index) => {
                    ...
                    if (energyBars[index]) {
                        ...
                        // Max value around 10000 for height scaling
    ...
    fetch(`${API_BASE}/api/analytics/water`)
        ...
        .then(data => {
            ...
            if (waterBars.length > 0 && data.length > 0) {
